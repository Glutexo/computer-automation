...
public enum SafariModule: ModuleModel {
    ...
    public static func execute(
        ...
        case SafariTabGroupSidebarListCommand.descriptor.name:
            return try CommandOutputRenderer.execute(SafariTabGroupSidebarListCommand(), arguments: arguments, outputFormat: outputFormat)
        case SafariTabGroupEnsureCommand.descriptor.name:
            return try CommandOutputRenderer.execute(SafariTabGroupEnsureCommand(), arguments: arguments, outputFormat: outputFormat)
        case SafariTabGroupFindCommand.descriptor.name:
        ...
        case SafariTabGroupRenameCommand.descriptor.name:
            return try CommandOutputRenderer.execute(SafariTabGroupRenameCommand(), arguments: arguments, outputFormat: outputFormat)
        ...
        case SafariTabResolveCommand.descriptor.name:
            return try CommandOutputRenderer.execute(SafariTabResolveCommand(), arguments: arguments, outputFormat: outputFormat)
